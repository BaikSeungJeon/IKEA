			...
			<table border="1" class="tdLeft">
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="password" name="password" placeholder="패스워드"
							id="userPw"></td>
					</tr>
					<tr>
						<th>비밀번호확인 <span>*</span></th>
						<td><input type="password" name="password02"
							placeholder="패스워드" id="userPw02"> <span
							class="txtPass red"></span></td>
					</tr>
					<tr>
						<th>이름*</th>
					...
					<tr>
						...
						<td>
							...
							<div class="mt10">
								<input type="text" name="address01" id="address01"><span
									class="badge">기본주소</span>
							</div>
							<div class="mt10">
								<input type="text" name="address02" id="address02"><span
									class="badge">나머지주소</span>
							</div>
						</td>
					</tr>
					<tr>
...
<script>
	function signCheck() {
		if (document.signUp.id.value == "") {
			...
			return false;
		} else if (document.signUp.password02.value == "") {
			alert("패스워드확인를 입력하시오.");
			document.signUp.password02.focus();
			return false;
		} else {
			return true;
		}
